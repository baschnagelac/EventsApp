...
function getEvents(element) {
    ...
    let cityName = element.getAttribute('data-string'); //from a tag element in template give me your data-string attribute which we set to be hte name of city they clcked on reducing to city data
